...
The CM Python API Client provides a simple way to access all data available via the Coin Metrics' API. D Use this client to query all kinds of data. In just a few lines of code, _anyone_ can access clean cryptocurrency data in a familiar form, such as a pandas dataframe. Detailed documentation & installation instructions can be found in the [Coin Metrics Python API Client](../../spaces/api-client-python/docs/README.md) reference space.
...
For more in depth information on how to use the Python API Client, see the [Python API Client docs](../../spaces/api-client-python/docs/README.md).
