...
* This metric represents the identity of the principal market from which the principal market price is calculated. If you are interested in the principal market price, please see the [Principal Market Price (USD)](https://coverage.coinmetrics.io/asset-metrics-v2/principal_market_price_usd) page for more details.\\
* Please see our [CM Prices Overview](https://gitlab.com/coinmetrics/front-end/knowledge-base/-/blob/master/docs/market-data/reference-rates-overview.md) for more information on methodology and policies.
