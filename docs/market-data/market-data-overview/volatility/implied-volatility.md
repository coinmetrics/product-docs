...
Note: If no far-term option expiring after the target date is available, the near-term option's implied volatility is used directly without interpolation.
