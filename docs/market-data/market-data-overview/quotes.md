...
For more information about our quotes data, please reference our [market order book](order-books.md) page.
...
Since our quotes data is derived from our order book data, please reference our [market order book](order-books.md) page for many frequently asked questions about order book data.
