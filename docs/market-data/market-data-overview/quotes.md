...
{% tab title="Shell" %}
```shell
curl --compressed "https://api.coinmetrics.io/v4/timeseries/market-quotes?markets=coinbase-btc-usd-spot&limit_per_market=5&page_size=10000&api_key=$CM_API_KEY"
```
{% endtab %}
