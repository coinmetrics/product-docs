...
{% tab title="Shell" %}
```shell
curl --compressed "https://api.coinmetrics.io/v4/timeseries/asset-metrics?assets=btc&metrics=open_interest_reported_future_usd&frequency=1d&limit_per_asset=3&page_size=10000&api_key=$CM_API_KEY"
```
{% endtab %}
