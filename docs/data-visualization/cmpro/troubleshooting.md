...
You are able to select a variety of resolutions for the [ExchCandles](https://gitlab.com/coinmetrics/front-end/knowledge-base/-/blob/master/docs/data-visualization/cmpro/broken-reference/README.md) data category. For the other data categories, the resolution is determined by the best fit for the data type (for more info see each [data category](https://gitlab.com/coinmetrics/front-end/knowledge-base/-/blob/master/docs/data-visualization/cmpro/broken-reference/README.md)):
