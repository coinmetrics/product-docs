...
* [Xfer Cnt](transfers.md#txtfrcnt)
* [Token Xfer Cnt](transfers.md#TxTfrTknCnt)
* [Xfer Mean Size](transfers.md#txtfrmeanbyte)
* [Per Byte Xfer'd Mean Val, Adj (USD)](transfers.md#txtfrvaladjbyte)
* [ERC-20 Xfer Cnt](transfers.md#txtfrerc20cnt)
* [ERC-721 Xfer Cnt](transfers.md#txtfrerc721cnt)
* [ERC-1155 Xfer Cnt](transfers.md#txtfrerc1155cnt)
...
| -------- | -------- | --------- | -------- |
| Xfer Cnt | TxTfrCnt | Transfers | 1 day    |
...
| Name           | MetricID      | Unit  | Interval       |
| -------------- | ------------- | ----- | -------------- |
| Xfer Mean Size | TxTfrMeanByte | Bytes | 1 day, 1 block |
...
| Name                                | MetricID        | Unit | Interval |
| ----------------------------------- | --------------- | ---- | -------- |
| Per Byte Xfer'd Mean Val, Adj (USD) | TxTfrValAdjByte | USD  | 1 day    |
...
| Name            | MetricID      | Unit      | Interval |
| --------------- | ------------- | --------- | -------- |
| ERC-20 Xfer Cnt | TxTfrERC20Cnt | Transfers | 1 day    |
...
| Name             | MetricID       | Unit      | Interval |
| ---------------- | -------------- | --------- | -------- |
| ERC-721 Xfer Cnt | TxTfrERC721Cnt | Transfers | 1 day    |
...
| Name              | MetricID        | Unit      | Interval |
| ----------------- | --------------- | --------- | -------- |
| ERC-1155 Xfer Cnt | TxTfrERC1155Cnt | Transfers | 1 day    |
