...
check-links: check-links-external check-links-internal
...
check-links-internal:
	...
	@echo "Note: Internal checking validates relative file paths and anchor fragments (#...). Use check-links-external for HTTP/HTTPS URLs."
