...
`coinmetrics.api_client.CoinMetricsClient.catalog_market_metrics_v2(markets=None, metrics=None, exchange=None, market_type=None, base=None, quote=None, asset=None, symbol=None, format='json_stream', page_size=None, paging_from=None, next_page_token=None)`
