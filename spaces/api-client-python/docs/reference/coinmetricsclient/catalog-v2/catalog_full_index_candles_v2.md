...
### `coinmetrics.api_client.CoinMetricsClient.catalog_full_index_candles_v2(indexes=None, page_size=None, paging_from=None, next_page_token=None, format='json_stream')`
