...
## `coinmetrics.api_client.CoinMetricsClient.catalog_full_asset_metrics_v2(assets=None, metrics=None, reviewable=None, page_size=None, paging_from=None, next_page_token=None, format='json_stream')`
