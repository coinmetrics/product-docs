...
* **Parameters:**
  * **assets** (*Optional* *[**Union* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *,* *List* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]* *]* *]*) – Comma-separated list of assets to query. Mutually exclusive with codes.
  * **codes** (*Optional* *[**Union* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *,* *List* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]* *]* *]*) – Comma-separated list of ten-digit alphanumeric identifying codes. Mutually exclusive with assets.
...
* **Parameters:**
  ...
  * **markets** (*Optional* *[**Union* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *,* *List* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]* *]* *]*) – List of markets.
