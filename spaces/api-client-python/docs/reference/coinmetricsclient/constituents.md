...
* **Parameters:**
  * **metric** ([*str*](https://docs.python.org/3/library/stdtypes.md#str)) – Target metric name.
  * **at_time** (*Optional* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]*) – Returns constituents at a specified date.
    Value now can be specified to get the current constituents.
    Mutually exclusive with start_time and/or end_time.
  * **end_time** (*Optional* *[**Union* *[**datetime* *,* *date* *,* [*str*](https://docs.python.org/3/library/stdtypes.md#str) *]* *]*) – End of the time interval, inclusive.
  ...
  * **start_time** (*Optional* *[**Union* *[**datetime* *,* *date* *,* [*str*](https://docs.python.org/3/library/stdtypes.md#str) *]* *]*) – Start of the time interval, inclusive.
    Multiple formats of ISO 8601 are supported: 2006-01-20T00:00:00Z, 2006-01-20T00:00:00.000Z, 2006-01-20T00:00:00.123456Z, 2006-01-20T00:00:00.123456789, 2006-01-20, 20060120.
    Mutually exclusive with at_time.
  ...
  * **format** (*Optional* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]*) – Format of the response. Supported values are json, csv. Default is json.
* **Returns:**
...
* **Parameters:**
  * **metric** ([*str*](https://docs.python.org/3/library/stdtypes.md#str)) – Target metric name.
  * **constituents** (*Optional* *[**Union* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *,* *List* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]* *]* *]*) – Comma separated list of constituents. By default all constituents are returned.
