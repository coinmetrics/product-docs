...
- [`parallel()`](#coinmetrics._data_collection.DataCollection.parallel) – return a [`ParallelDataCollection`](parallel_data-collection.md#coinmetrics._data_collection.ParallelDataCollection) that splits
  ...
  [`export_to_csv_files()`](parallel_data-collection.md#coinmetrics._data_collection.ParallelDataCollection.export_to_csv_files),
  [`export_to_json_files()`](parallel_data-collection.md#coinmetrics._data_collection.ParallelDataCollection.export_to_json_files), and so on.

* **Parameters:**
  * **data_retrieval_function** (*DataRetrievalFuncType*)
  * **endpoint** ([*str*](https://docs.python.org/3/library/stdtypes.md#str))
  * **url_params** (*Dict* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *,* *UrlParamTypes* *]*)
  * **csv_export_supported** ([*bool*](https://docs.python.org/3/library/functions.md#bool))
  * **client** (*Optional* *[*[*CoinMetricsClient*](coinmetricsclient.md#coinmetrics.api_client.CoinMetricsClient) *]*)
  * **paginated** ([*bool*](https://docs.python.org/3/library/functions.md#bool))
  * **kwargs** (*Any*)
...
Convert this [`DataCollection`](#coinmetrics._data_collection.DataCollection) into a [`ParallelDataCollection`](parallel_data-collection.md#coinmetrics._data_collection.ParallelDataCollection),
...
* **Returns:**
  A [`ParallelDataCollection`](parallel_data-collection.md#coinmetrics._data_collection.ParallelDataCollection) that mirrors the original
  request but executes its workload across multiple workers.
* **Return type:**
  [ParallelDataCollection](parallel_data-collection.md#coinmetrics._data_collection.ParallelDataCollection)
...
* **Parameters:**
  ...
  * **csv_export_supported** ([*bool*](https://docs.python.org/3/library/functions.md#bool))
  * **client** (*Optional* *[*[*CoinMetricsClient*](coinmetricsclient.md#coinmetrics.api_client.CoinMetricsClient) *]*)
  * **metric_type** (*Optional* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]*)
  * **iterable_col** (*Optional* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]*)
  * **iterable_key** (*Optional* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]*)
  * **explode_on** (*Optional* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]*)
  * **assign_to** (*Optional* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]*)
  * **nested_catalog_columns** (*List* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *]*)
...
* **Parameters:**
  * **dtype_mapper** (*Optional* *[**Dict* *[*[*str*](https://docs.python.org/3/library/stdtypes.md#str) *,* *Any* *]* *]*) – Optional dictionary mapping column names to pandas
    dtypes. Overrides schema-derived types for the specified columns.
  * **dataframe_type** ([*str*](https://docs.python.org/3/library/stdtypes.md#str)) – Type of dataframe to return – either `"pandas"`
    (default) or `"polars"`.
  * **decimal_as_string** ([*bool*](https://docs.python.org/3/library/functions.md#bool)) – If `True`, decimal columns are returned as
